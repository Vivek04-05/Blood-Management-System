...
public class DeleteRecevier extends JFrame implements ActionListener,WindowListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteRecevier frame = new DeleteRecevier();
	 ...
	 * Create the frame.
	 */
	public DeleteRecevier() {
		con=DatabaseConnection.createConnection();
		setIconImage(Toolkit.getDefaultToolkit().getImage(DeleteRecevier.class.getResource("/ImagesBlood/delete.png")));
		setTitle("Delete Recevier");
		...
		JLabel lblNewLabel = new JLabel("Delete Recevier");
		lblNewLabel.setFont(new Font("Serif", Font.BOLD, 23));
		lblNewLabel.setBounds(161, 23, 146, 37);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Enter Recevier Name");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1.setBounds(71, 99, 165, 23);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("Enter Recevier Phonr No.");
		lblNewLabel_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1_1.setBounds(71, 153, 183, 23);
